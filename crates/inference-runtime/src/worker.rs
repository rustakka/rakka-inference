...
//! re-used verbatim from atomr-accel's `error` module — that's the
...
impl Actor for WorkerActor {
    ...
    fn supervisor_strategy(&self) -> SupervisorStrategy {
        ...
        // don't pull atomr-accel but still happen to mount a local
                ...
                tokio::spawn(async move {
                    ...
                    match g.execute(batch).await {
                        ...
                        Err(e) => {
                            ...
                            // tagged with atomr_accel's CONTEXT_POISONED_TAG
