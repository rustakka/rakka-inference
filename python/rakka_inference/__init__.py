"""rakka-inference — Python entry point for the Rust actor-based inference runtime.

The native PyO3 extension lives in :mod:`rakka_inference._native`; this
package re-exports the public surface so users write::

    from rakka_inference import Cluster, Deployment

instead of touching the underscore-prefixed extension module directly.

The current 0.2.x surface is intentionally narrow — `Deployment` value
